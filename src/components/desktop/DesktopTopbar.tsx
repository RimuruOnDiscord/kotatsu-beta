          ...
          >
            {isActive && (
              <motion.div
                ...
                className="absolute inset-0 rounded-[10px] z-0 shadow-[inset_0_1px_0_rgba(255,255,255,0.1),inset_0_0_0_1px_rgba(255,255,255,0.035),0_12px_28px_-22px_var(--app-accent,#8b5cf6)]"
                style={{
            ...
            {!isActive && (
              <div className="absolute inset-0 rounded-[10px] bg-white/[0.04] opacity-0 scale-95 transition-all duration-300 group-hover:opacity-100 group-hover:scale-100 z-0 border border-transparent group-hover:border-white/[0.055] group-hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]" />
            )}
      ...
      <div className="mx-auto hidden w-full max-w-[1460px] lg:flex items-center justify-between px-6 py-4 relative z-50">
        ...
        <div className="flex shrink-0 items-center gap-3.5">
          ...
          <div ref={searchRef} className="relative flex items-center">
            <div
              className={`relative flex items-center overflow-hidden transition-all duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] ${isSearchFocused || searchQuery.length > 0 || appliedFilters.length > 0 ? 'w-[430px]' : 'w-[280px]'
                }`}
              style={{
                ...pillStyle,
                ...
                {appliedFilters.map((filter) => {
                  ...
                  return (
                    <motion.button
                      ...
                      className="mr-1.5 flex max-w-[150px] shrink-0 items-center gap-1.5 rounded-[8px] border px-2 py-1 text-[11.5px] font-medium text-white outline-none"
                      style={{
            ...
            <AnimatePresence>
              {isSearchDropdownOpen && isSearchFocused && (
                <div className="absolute top-[calc(100%+14px)] left-1/2 -translate-x-1/2 z-[100] w-[420px]">
                  <motion.div
                    variants={dropdownVariants}
                    initial="hidden"
                    animate="visible"
                    exit="exit"
                    className="relative flex flex-col rounded-[12px] w-full overflow-hidden"
                    style={{
                      border: '1px solid rgba(255,255,255,0.08)',
                  ...
                  >
                    <div className="flex flex-col w-full rounded-[12px] overflow-hidden relative z-10">
                      {showDiscordMenu && (
                        <div className="relative z-10 px-2 pt-1.5 pb-2">
                          <div className="flex items-center justify-between px-3 pt-1.5 pb-1.5">
                            <span className="text-[10.5px] font-bold uppercase tracking-[0.15em] text-[color-mix(in_srgb,var(--app-accent,#fb923c)_82%,white_8%)]" style={{ fontFamily: TOPBAR_FONT }}>Filters</span>
                          ...
                          <div className="flex flex-col gap-[3px]">
                            {visibleDiscordFilters.map((filter) => {
                              ...
                              return (
                                <motion.button
                                  ...
                                  className="group/filter flex w-full items-center gap-3.5 rounded-[12px] border border-transparent px-3 py-2.5 text-left outline-none transition-all duration-200 hover:border-white/[0.07] hover:bg-white/[0.055] focus-visible:border-white/[0.12] focus-visible:bg-white/[0.05]"
                                >
                            ...
                            {!showAllFilters && (
                              <motion.button
                                ...
                                className="group/more flex w-full items-center gap-3.5 rounded-[12px] border border-transparent px-3 py-2.5 text-left outline-none transition-all duration-200 hover:border-white/[0.07] hover:bg-white/[0.055] focus-visible:border-white/[0.12] focus-visible:bg-white/[0.05]"
                              >
                          ...
                          {hasRecentSearches && (
                            <>
                              ...
                              <div className="px-3 pt-1 pb-1.5 text-[10.5px] font-bold uppercase tracking-[0.15em] text-[color-mix(in_srgb,var(--app-accent,#fb923c)_82%,white_8%)]" style={{ fontFamily: TOPBAR_FONT }}>
                                Recent searches
                              </div>
                              {visibleRecentSearches.map((entry) => (
                                <motion.div
                                  ...
                                  className="group/item flex w-full items-center gap-3 rounded-[10px] border border-transparent px-3 py-1.5 mb-[3px] text-left outline-none transition-all duration-200 hover:border-white/[0.07] hover:bg-white/[0.055] focus-visible:border-white/[0.12] focus-visible:bg-white/[0.05] cursor-pointer"
                                >
                              ...
                              {hiddenRecentSearchCount > 0 && (
                                <motion.button
                                  ...
                                  className="group/recent-more mt-1 flex w-full items-center justify-center gap-2 rounded-[10px] border border-white/[0.07] bg-white/[0.025] px-3 py-2 text-[12px] font-semibold text-zinc-400 outline-none transition-all duration-200 hover:border-white/[0.13] hover:bg-white/[0.055] hover:text-white focus-visible:border-white/[0.14]"
                                  style={{ fontFamily: TOPBAR_FONT }}
                                >
                                  Show more
                      ...
                      {activeFilter && activeFilterValues.length > 0 ? (
                        <div className="flex flex-col px-1">
                          <div className="px-2 pb-3 pt-1" style={{ fontFamily: TOPBAR_FONT }}>
                          ...
                          {filteredActiveFilterValues.length > 0 ? (
                            filteredActiveFilterValues.map((option) => {
                              ...
                              return (
                                <motion.button
                                  ...
                                  className={`group/filter flex w-full items-center gap-3.5 rounded-[12px] px-3 py-2.5 text-left outline-none transition-all ${alreadyApplied ? 'opacity-40 cursor-default' : ''}`}
                            ...
                            <motion.div variants={itemVariants} className="rounded-[16px] border border-white/[0.06] bg-white/[0.02] px-4 py-5 text-[13.5px] font-medium text-zinc-500" style={{ fontFamily: TOPBAR_FONT }}>
                        ...
                        displayResults.length > 0 ? (
                          <div className="flex flex-col">
                            <div className="flex items-center justify-between px-3.5 pt-2.5 pb-2 mb-1" style={{ borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
                            ...
                            {displayResults.map((result) => {
                              ...
                              return (
                                <motion.button
                                  ...
                                  className="group/item relative flex w-full items-center gap-3 rounded-[10px] p-1.5 mb-[2px] text-left outline-none transition-all duration-200 bg-transparent hover:bg-white/[0.06]"
                                >
                          ...
                          <motion.div variants={itemVariants} className="flex flex-col items-center justify-center py-12 px-6 text-center">
                        ...
                        userSuggestions.length > 0 && !showDiscordMenu ? (
                          ...
                          !activeSearchValue.trim() ? (
                            <motion.div variants={itemVariants} className="flex flex-col items-center justify-center py-10 px-6 text-center">
                      ...
                      {showFooter && (
                        <motion.button
                          ...
                          className="w-full relative z-10 flex items-center justify-between px-4 py-3 outline-none group cursor-pointer transition-colors duration-200 hover:bg-white/[0.03] active:bg-white/[0.05] rounded-b-[18px]"
          ...
          >
            ...
            <motion.button
              ...
              className={`group relative flex items-center justify-center rounded-[10px] transition-colors duration-200 ease-out hover:bg-white/[0.08] hover:text-white ${isFriendsOpen ? 'bg-white/[0.08] text-white' : 'text-zinc-400'}`}
              style={{ width: 32, height: 32 }}
            >
